...
![Capa do Complemento Referência Certa](assets/media/rc-cover.png "Capa do Complemento Referência Certa.")
...
![Passo1](assets/media/rc-screen-1.png ":footprints: Passo 1: Acesse no menu a opção **Referência Certa** para abrir a barra laterial e gerar suas **referências**.")
...
![Passo3](assets/media/rc-screen-3.png "Passo 3: Após _adicionar os artigos_ é só clicar em **Inserir Referências** e serão inseridas as **Referências** no **Documento**.")
